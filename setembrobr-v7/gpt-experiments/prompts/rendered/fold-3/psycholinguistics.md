...
Focus on self-reference, first-person singular versus plural, affect, absolutist language,
negation, temporal orientation, emotional vocabulary, loneliness, social connectedness,
hopelessness, agency, certainty, rumination, and conversational stance. Test user-level effects
and interactions rather than assuming published English-language findings transfer to Brazilian
Portuguese.
