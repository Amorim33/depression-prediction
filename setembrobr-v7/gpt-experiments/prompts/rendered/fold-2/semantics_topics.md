...
Focus on semantic and topical evidence: personal narratives, relationships, isolation, work or
study impairment, treatment and medication, explicit diagnosis statements, physical symptoms,
future orientation, social participation, humor, fandom, politics, news, and other topics that
may distinguish labels. Test whether topics are self-experienced, persistent, and specific rather
than relying on topic words in isolation.
