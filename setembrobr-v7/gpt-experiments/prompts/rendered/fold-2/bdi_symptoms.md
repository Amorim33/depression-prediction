...
Focus on BDI-aligned symptom domains without pretending tweets form a clinical BDI instrument:
sadness, pessimism, perceived failure, loss of pleasure, guilt, punishment, self-dislike,
self-criticism, self-harm or death ideation, crying, agitation, loss of interest, indecision,
worthlessness, low energy, sleep, irritability, appetite, concentration, fatigue, and libido.
Measure which domains and combinations actually diverge, how persistent/self-referential they
are, and which apparently relevant domains do not generalize across development folds.

# Immutable run context

Outer held-out fold: 2.
Development folds: [0, 1, 3, 4].
Development users: 6082.
Role ID: `bdi_symptoms`.

Attached development files:
- source fold 0: SHA-256 `2d447aa9618d91232ed359457473e958d6788ccdb24048e29148c80ee08211fb`, 1521 users
